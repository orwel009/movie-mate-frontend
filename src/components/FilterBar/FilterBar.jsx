...
const FilterBar = ({ filters, setFilters, genres, platforms, showStatus =true }) => {
  ...
  return (
    <div style={{display:'flex',gap:8,marginBottom:12,flexWrap:'wrap',alignItems:'center'}}>
      ...
      {showStatus && (<select value={filters.status} onChange={handle('status')}><option value="">Any status</option><option value="watching">Watching</option><option value="completed">Completed</option><option value="wishlist">Wishlist</option></select>)}
